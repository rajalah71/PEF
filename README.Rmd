...
Asthma diagnosis: A person is said to have asthma if the relative effect of medication is over 15$\%$ with at least 3/14 probability OR the relative effect of time of day is over 20$\%$ with at least 3/14 probability. A reference value for the person in question is 442 liters per minute.

```{r, echo=FALSE}
pefdata <- read.csv("~/Desktop/R_projektit/PEF/pefdata.csv")
```

Let us define a Bayesian model for the PEF measurements.
...
# Draw samples
model_simple <- rstan::sampling(simple, stan_data, chains = cores, iter = 50000)
